...
import Themeprimarycolor, * as switcherdata from "./switcherdata/authenticationswitcherdata";
    ...
    <Fragment>
      ...
      <div id="hs-overlay-switcher" className="hs-overlay hidden ti-offcanvas ti-offcanvas-right" tabIndex={-1}>
        ...
        <div className="ti-offcanvas-footer sm:flex justify-between">
          <Link to="#" onClick={() => switcherdata.Reset(ThemeChanger)} id="reset-all" className="w-full ti-btn ti-btn-danger-full m-1">Reset</Link> </div>
      </div>
    </Fragment>
  );
}
